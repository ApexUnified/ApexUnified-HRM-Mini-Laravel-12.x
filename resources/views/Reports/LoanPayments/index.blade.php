            ...
            <div class="col-lg-12 mt-5">
                <div class="card">
                    <div class="card-body">
                        ...
                        @include('Partials.Report.LoanPayment.table_body', [
    ...
    @section('js')
        ...
        <script>
            $(document).ready(function() {
                $(document).on('click', '#loanPayment-pagination-links a', function(e) {
                    e.preventDefault();
                    ...
                    $.get(pageUrl, function(data) {
                        ...
                        let newRows = htmlData.find(".loanPayment-table-rows");
                        let newPagination = $(htmlData).find("#loanPayment-pagination-links")
                            .html();
                        ...
                        if (newPagination) {
                            $("#loanPayment-pagination-links").html(newPagination);
                        } else {
