...
<body>
                        ...
                        <ul class="metismenu" id="menu">
                            ...
                            <li>
                                ...
                                <ul class="collapse">
                                    ...
                                    <li class="{{ request()->routeIs('overtime.index') ? 'active' : '' }}"><a
                                            href="{{ route('overtime.index') }}"><span>Overtimes List</span></a>
                                    </li>

                                    @can('Overtime Create')
                                    <li class="{{ request()->routeIs('overtime.create') ? 'active' : '' }}"><a
                                            href="{{ route('overtime.create') }}"><span>Overtime Create</span></a>
                                    </li>
                                    @endcan
                                </ul>
                            </li>
                            ...
                            <li>
                                ...
                                <ul class="collapse">
                                    ...
                                    <li class="{{ request()->routeIs('overtimepay.index') ? 'active' : '' }}"><a
                                            href="{{ route('overtimepay.index') }}"><span>Overtime Pay</span></a>
                                    </li>


                                    <li
                                        class="{{ request()->routeIs('attendancepaydeduction.index') ? 'active' : '' }}">
                                        <a href="{{ route('attendancepaydeduction.index') }}"><span>Deduction Pay
                                            </span></a>
                                    </li>
                    ...
                    <div class="clearfix col-md-6 col-sm-4 d-flex justify-content-end">
                        <ul class="notification-area pull-right d-flex align-items-center">
                            ...
                            <div class="user-profile pull-right">
                                ...
                                @if (!$user->profile)
                                <img class="avatar user-thumb" src="{{ asset('assets/images/user-profile/user.jpeg') }}"
                                    alt="avatar">
                                @else
                                <img class="avatar user-thumb"
                                    src="{{ asset('assets/images/user-profile/' . $user->profile) }}" alt="avatar">
                                @endif
    ...
    {{-- FilePond --}}
    <script
        src="{{ asset('assets/lib/filepond-plugin-file-validate-size/filepond-plugin-file-validate-size.min.js') }}">
    </script>
    <script
        src="{{ asset('assets/lib/filepond-plugin-file-validate-type/filepond-plugin-file-validate-type.min.js') }}">
    </script>
