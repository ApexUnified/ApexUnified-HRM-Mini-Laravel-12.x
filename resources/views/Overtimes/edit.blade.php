            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('overtime.update', $overtime->id) }}" method="POST">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="employee_id" id="employee_id" class="form-control">
                                        ...
                                        <option value="{{ $employee->id }}" {{ $employee->id == $overtime->employee_id
                                            ? "selected" : "" }}>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" step="0.01" name="rate_per_hour" id="rate_per_hour"
                                            class="form-control" disabled value="{{ $overtime->rate_per_hour }}">
                                    </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" step="0.01" name="hours_worked" id="hours_worked"
                                        class="form-control" value="{{ $overtime->hours_worked }}">
                                </div>
                                @error('hours_worked')
                                <small class="text-danger">{{ $message }}</small>
                                @enderror
                        ...
                        <button class="btn btn-primary" type="submit">Update Overtime</button>
                    </form>
