...
@section('content')
                    ...
                    <div class="card-body">
                        ...
                        <div class="single-table mt-5">
                            <div class="data-tables">
                                <table id="role_table" class="text-center">
    ...
    @section('js')
        ...
        <script>
            $(document).on("click", ".role-delete-form", function(e) {
                let form = this;
                e.preventDefault();
                Swal.fire({
                    title: 'Confirmation',
                    text: 'Do You Really Want To Delete This Role ? This Action Cannot Be Reversable',
                    icon: 'info',
