                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center mb-5">
                            <h2 class="display-5">Edit Branch</h2>
                        ...
                        <form action="{{ route('branch.update', $branch) }}" method="POST">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <input type="text" id="latitude" name="latitude" value="{{ $branch->latitude }}"
                                        hidden>
                                    <input type="text" id="longtitude" name="longtitude"
                                        value="{{ $branch->longtitude }}" hidden>
                            ...
                            <button class="btn btn-primary my-3" type="submit">Update Branch</button>
                        </form>
    ...
    @section('js')
        ...
        <script>
            $(document).ready(function() {
                ...
                let initial_lat = document.getElementById('latitude').value.trim();
                let initial_lng = document.getElementById('longtitude').value.trim();
                ...
                var map = L.map("location").setView([initial_lat, initial_lng], 13);
                ...
                var marker = L.marker([initial_lat, initial_lng]).addTo(map)
                    .bindPopup("Stored Location").openPopup();
